...
DB_FILE = os.path.join(BASE_DIR, 'dose_tracker.db')
SCHEMA_FILE = os.path.join(BASE_DIR, 'sql', 'schema.sql')
DATA_FILE = os.path.join(BASE_DIR, 'patient_data.json')
TABLE_FILE = os.path.join(BASE_DIR, 'patient_table.json')
DRUG_FILE = os.path.join(BASE_DIR, 'drug_list.json')
...
def load_existing_data(filename):
    ...
    if os.path.exists(filename):
        try:
            ...
            return [] if filename != DRUG_FILE else {}
    return [] if filename != DRUG_FILE else {}
